...
interface Props {
	...
	data: {
		...
		tags?: string[],
		info: { [key: string]: string | number | React.JSX.Element },
...
function Table(props: BaseProps<Props>) {
	const { globalHeader, header, data, style, extraClasses } = props;
	...
	return <div className={
		makeClassName([
			"table-component flex-column-fill",
			extraClasses,
		])
	} style={style}>
		<div className="table y-scroll-a owlTestClass2">
			<table className="owlTestClass3">
				<thead>
